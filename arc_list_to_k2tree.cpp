...
int main(int argc, char** argv){
    ...
    arclist.close();
    sdsl::k2_tree<2, sdsl::bit_vector, sdsl::rank_support_v<1,1>::bit_vector_type> k2_representation = sdsl::k2_tree<2, sdsl::bit_vector, sdsl::rank_support_v<1,1>::bit_vector_type>(arc_vector, nodes);
